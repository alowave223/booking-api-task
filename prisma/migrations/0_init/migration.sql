...
-- CreateIndex
CREATE INDEX "bookings_userId_checkIn_idx" ON "bookings"("userId", "checkIn");
...
-- CreateIndex
CREATE UNIQUE INDEX "bookings_roomId_checkIn_key" ON "bookings"("roomId", "checkIn");

-- CreateIndex
CREATE UNIQUE INDEX "bookings_roomId_checkOut_key" ON "bookings"("roomId", "checkOut");
